...
class GoForward():
	...
	def RGBCallback(self,data):
		...
		# low = np.array([50, 70, 100], dtype = 'uint8')
		# high = np.array([70, 90, 120], dtype = 'uint8')
		
		low = np.array([130, 50, 200], dtype = 'uint8')
		high = np.array([190, 90, 255], dtype = 'uint8')
		...
		self.lin_vel = 0.01* (centroid_y + 100 - (max_y/2))
